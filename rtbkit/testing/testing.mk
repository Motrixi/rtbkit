...
$(eval $(call test,win_cost_model_test,openrtb_exchange bidding_agent zmq_augmentor integration_test_utils,boost))
$(eval $(call test,bidder_test,openrtb_exchange bidding_agent zmq_augmentor integration_test_utils,boost))
...
$(eval $(call test,exchange_parsing_from_file_test,openrtb_bid_request rtb_router zmq_augmentor openrtb_exchange,boost))
